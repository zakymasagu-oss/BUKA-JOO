...
const messages = [
    "TERSERAH NGA TNDIS DI MNA",
    "HEY LUJII🤭",
    "GW MAU NGOMONG SESUATU NIHH",
    "CBA NGA TNDIS ULNG",
    "TINDIS BAE² BBI",
    "DOH ADA SRUH TINDIS",
    "TNDIS BAE² KUA",
    "BA BAE² EEK",
    "ADOHH",
    "KURNG MO TNDIS KUA EE",
    "NAH ITUU DNGG",
    "SANTAI JNGN B PSTIU",
    "CHILL BROO",
    "IKAN² APA YG DI JEMUR?",
    "IKAN ASINGG",
    "AWOKAWOK AWOKAWOK",
    "JNGN B WACANA TRUS KUA EE,ADOHH",
    "PNDOO❤️",
    "BJIRLAHHH",
    "CBA NGA TNDIS TMBOL DI BWAH ITUU "
];
